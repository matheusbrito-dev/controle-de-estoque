			...
			<div class="panel panel-green">
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
							<label>Preço</label>
							<html:text styleClass="form-control input-sm dinheiro obrigatorio" styleId="preco" name="produtoForm" property="produto.precoToString" />
						</div>
						
						<div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
							<label>Unidade</label>
							<html:select styleClass="form-control input-sm obrigatorio" styleId="unidadeMedida" name="produtoForm" property="produto.unidadeMedida.idToString" >
								<html:option value="">Selecione...</html:option>
								<html:optionsCollection name="produtoForm" property="comboUnidadeMedidas" label="label" value="value"/>
							</html:select>
						...
						<div class="form-group col-lg-8 col-md-6 col-sm-12 col-xs-12">
							...
							<html:select styleClass="form-control input-sm obrigatorio" styleId="categoria" name="produtoForm" property="produto.categoria.idToString" >
								<html:option value="">Selecione...</html:option>
