				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
							<label>Código</label>
							<html:text styleClass="form-control input-sm bloqueado" styleId="id" name="categoriaForm" property="categoria.idToString" />

						</div>

						<div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
							<label>Data cadastro</label>
							<html:text styleClass="form-control input-sm bloqueado" styleId="dataHoraCadastro" name="categoriaForm" property="categoria.dataHoraCadastroToString" />

						</div>

						<div class="form-group col-lg-8 col-md-6 col-sm-12 col-xs-12">
							<label>Nome</label>
							<html:text styleClass="form-control input-sm obrigatorio" styleId="nome" name="categoriaForm" property="categoria.nome" />
						</div>
					</div>
